...
def parse_args():
    ...
    parser.add_argument("--src_json", default="datasets/annotations/refcoco-mixed/instances_train.json", type=str, help="")
    parser.add_argument("--des_json", default="datasets/annotations/refcoco-mixed/instances_train_video.json", type=str, help="")
...
if __name__ == "__main__":
    ...
    for img_dict in src_dataset["images"]:
        ...
        vid_dict["expressions"] = img_dict["expressions"]
