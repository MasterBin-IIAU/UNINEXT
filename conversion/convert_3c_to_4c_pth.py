...
def parse_args():
    ...
    parser.add_argument("--src_path", default="outputs/image_joint_r50/model_final.pth", type=str, help="")
    parser.add_argument("--des_path", default="outputs/image_joint_r50/model_final_4c.pth", type=str, help="")
...
if __name__ == "__main__":
    ...
    for k, v in data["model"].items():
        ...
        if "stem.conv1.weight" in k:
            new_value = torch.zeros((64, 4, 7, 7), dtype=torch.float32)
            new_value[:, :-1, :, :] = v
