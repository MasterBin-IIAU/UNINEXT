...
def parse_args():
    ...
    parser.add_argument("--src_path", default="image_joint_r50/model_final.pth", type=str, help="")
    parser.add_argument("--des_path", default="image_joint_r50/model_final_4c.pth", type=str, help="")
